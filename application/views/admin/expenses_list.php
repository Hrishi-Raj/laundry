													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														<thead>
															<tr>
																...
																<th> Date </th>
																<th > Payee Name </th>
																<th class="hidden-480"> Exp Type </th>
														...
														<tbody>
															<?php foreach ($expenses->result() as $row): ?>
															<tr>
																<td class="center">
																	<label class="pos-rel">
																		<input type="checkbox" class="ace" />
																...
																<td class="hidden-480"><?php echo $row->exp_paidby; ?> </td>																
																<td class=""><?php echo $row->exp_amt; ?> </td>
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/expense_crud/do_update/<?php echo $row->exp_id;?>');" class="tooltip-success" data-rel="tooltip" title="Edit">
																						<span class="green">
																				...
																				<li>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/expense_crud/delete/<?php echo $row->exp_id;?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
																						<span class="red">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select class="form-control" name="exp_amt_paid_by" id="exp_amt_paid_by">
													<option value="">-- Select --</option>
													<option value="bycash" selected>By Cash</option>
