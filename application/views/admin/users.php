								...
								<div class="tab-content">
															...
															<tr>
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="blue tooltip-info" data-rel="tooltip"  href="<?php echo base_url();?>index.php/admin/customer_profile/<?php echo $row->id;?>" title="View">
																			<i class="ace-icon fa fa-search-plus bigger-130"></i>
																		</a> 

																		<a class="green tooltip-success" data-rel="tooltip" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/customer_crud/do_update/<?php echo $row->id;?>');" title="Edit">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>

																		<a class="red tooltip-error" data-rel="tooltip" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/customer_crud/delete/<?php echo $row->id;?>');" title="Delete" >
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/customer_crud/do_update/<?php echo $row->id;?>');" class="tooltip-success" data-rel="tooltip" title="Edit">
																						<span class="green">
																				...
																				<li>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/customer_crud/delete/<?php echo $row->id;?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																						<span class="red">
									...
									<div class="">
										...
										<div class="form-group ">
											<label class="col-sm-3 control-label no-padding-right" for="user_id"> Customer ID : </label>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="status"> <span style="color:#5cb85c!important;"> Login Status : </span>  </label>
