				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"><?php //echo strtoupper($this->session->userdata('user_name')); ?></li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<?php echo strtoupper($userrow->first_name); ?> Profile
												...
												<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
													<div class="inline position-relative">
														<a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
															...
															&nbsp;
															<span class="white"><?php echo $userrow->first_name ." ".$userrow->last_name; ?> </span>
														</a>
...
&nbsp;
											...
											<div class="profile-contact-info">
												<div class="profile-contact-links align-left">
													<a href="#" class="btn btn-link" onclick="Profile('<?php echo base_url();?>index.php/admin/customer_crud/do_update/<?php echo $userrow->id; ?>');" >
										...
										<?php
										$query=$this->db->query('SELECT * FROM customer_order WHERE customer_id='.$userrow->id);
										...
										<div class="col-xs-12 col-sm-9">
											<div class="center">
												<span class="btn btn-app btn-sm btn-grey no-hover">
													<span class="line-height-1 bigger-170"> <?php echo $query->num_rows(); ?> </span>

													<br />
													<span class="line-height-1 smaller-90"> Total </span>
												</span>
												<span class="btn btn-app btn-sm btn-pink no-hover">
													<span class="line-height-1 bigger-170"> <?php echo $penquery->num_rows(); ?> </span>
												...
												<span class="btn btn-app btn-sm btn-success no-hover">
													<span class="line-height-1 bigger-170"> <?php echo $delquery->num_rows(); ?> </span>

													<br />
													<span class="line-height-1 smaller-90">Delivery </span>
												</span>
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo $userrow->first_name ." ".$userrow->last_name; ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="signup"> <?php echo $userrow->mobile; ?> </span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="about"><?php echo $userrow->email_id; ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="signup"> <?php echo $userrow->address; ?> </span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="login">1 min ago </span>
													</div>
												</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header" style="background:#fbeed5;" >
                    ...
                    <h4 class="modal-title"><?php echo "Edit Profile "; ?></h4>
                </div>
