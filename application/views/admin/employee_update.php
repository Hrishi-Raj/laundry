...
foreach ($employee_edit as $row): ?>
		...
		<div class="">
			...
			<form class="form-horizontal " id="user_edit-form" method="post" action="<?php echo base_url();?>index.php/admin/employee_crud/modify/<?php echo $row->emp_id; ?>">
			
			<div class="form-group ">
				<label class="col-sm-3 control-label no-padding-right" for="service_id"> Customer ID : </label>

				<div class="col-sm-9">
					<input type="text" id="service_id" class="form-control" required readonly value="<?php echo $row->emp_id;?>" />
				</div>
			</div>
