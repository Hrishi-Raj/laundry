			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
							...
							<a class="btn btn-success" href="<?php echo base_url();?>index.php/admin/"> 
							...
							<a class="btn btn-warning" href="<?php echo base_url();?>index.php/admin/expenses"> 
							<i class="ace-icon fa fa-inr" title="Price_List" style="color:white;"></i>
							</a>
					

						
							<a class="btn btn-danger" href="<?php echo base_url();?>index.php/admin/"> 
