				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<i class="ace-icon fa fa-truck green"></i>
									<span class="red">Laundry</span>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" name="username" id="username" placeholder="Username" autocomplete="off" required autofocus/>
													...
													<div class="clearfix">
														...
														<input type="submit" class="width-35 pull-right btn btn-sm btn-primary" value="Login" name="login" >
